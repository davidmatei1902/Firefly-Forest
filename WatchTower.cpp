...
void WatchTower::Render(const std::unordered_map<std::string, Mesh*>& meshes, Shader* shader,
    ...
    for (int i = 0; i < 4; i++) {
        ...
        RenderSimpleMesh(meshes.at("cylinder"), shader, modelMatrix, glm::vec3(0.3f, 0.2f, 0.1f), viewMatrix, projectionMatrix, texture);
    }
    ...
    // platform
    {
        ...
        RenderSimpleMesh(meshes.at("box"), shader, modelMatrix, glm::vec3(0.35f, 0.25f, 0.15f), viewMatrix, projectionMatrix, texture);
    }
    ...
    // roof
    {
        ...
        RenderSimpleMesh(meshes.at("cone"), shader, modelMatrix, glm::vec3(0.2f, 0.1f, 0.05f), viewMatrix, projectionMatrix, texture);
    }
}
